...
(function () {
    ...
    const fetchHook = esmsInitOptions.fetch
    ...
    function parse(k, l = "@") {
        ...
        for (; e.re(); ) {
            const r = e.es(),
                a = t.charCodeAt(r);
            d.push(
                34 === a || 39 === a ? u(r + 1, a) : t.slice(e.es(), e.ee())
            );
        }
        return [w, d, !!e.f()];
    }
